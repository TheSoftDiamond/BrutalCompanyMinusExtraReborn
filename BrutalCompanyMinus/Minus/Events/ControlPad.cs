...
namespace BrutalCompanyMinus.Minus.Events
{
    internal class ControlPad : MEvent
    {
        ...
        public override void Initalize()
        {
            ...
            EventsToRemove = new List<string>() { nameof(SID), nameof(RealityShift), nameof(Pickles), nameof(SussyPaintings),/* nameof(TakeyGokuPlush), nameof(TakeyGokuPlushBig),*/ nameof(Dustpans), nameof(Clock), nameof(ZedDog) };
