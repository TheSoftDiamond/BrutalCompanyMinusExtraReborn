...
{
    [HarmonyPatch]
    internal class DoorOverDriveNet : NetworkBehaviour
    {
        public static DoorOverDriveNet instance;
        ...
        {
            Events.DoorOverdriveEv.Instance.Active = false;
            GameObject netObject = GameObject.Find("DoorOverdriveEvEvent");
            if (netObject != null)
            {
